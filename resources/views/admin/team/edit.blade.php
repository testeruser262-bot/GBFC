...
<div class="card border-0 shadow-sm p-4" style="border-radius: 20px;">
    <div class="d-flex justify-content-start align-items-center">
        ...
        <div class="ms-3">
            <span class="fs-6 text-primary fw-bolder">Teams / Edit</span><br/>
            <span class="fw-bold pt-3 fs-5">Edit Team</span>
        </div>
        ...
        <form action="{{ url('/team/update/'.$team->teamId) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    <label class="form-label fw-bolder">Team Name</label>
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <select name="age_group"
                        ...
                        <option value="U10" {{ $team->ageGroup == 'U10' ? 'selected' : '' }}>U10</option>
                        <option value="U12" {{ $team->ageGroup == 'U12' ? 'selected' : '' }}>U12</option>
                        <option value="U14" {{ $team->ageGroup == 'U14' ? 'selected' : '' }}>U14</option>
                        <option value="U16" {{ $team->ageGroup == 'U16' ? 'selected' : '' }}>U16</option>
                        <option value="U18" {{ $team->ageGroup == 'U18' ? 'selected' : '' }}>U18</option>
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <select name="gender"
                        ...
                        <option value="Coed" {{ $team->gender == 'Coed' ? 'selected' : '' }}>Coed</option>
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <textarea name="description"
                              ...
                              style="background-color: #f8f9fa; border-radius: 12px; min-height: 120px;">{{ $team->description }}</textarea>
