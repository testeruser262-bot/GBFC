                ...
                <table class="table mb-0 custom-table">
                    <thead>
                        <tr>
                            ...
                            <th class="text-uppercase" style="width:13%">Player Name</th>
                            <th class="text-uppercase" style="width:13%">Email</th>
                            <th class="text-uppercase" style="width:10%">Phone No.</th>
                            <th class="text-uppercase" style="width:10%">D.O.B</th>
                            <th class="text-uppercase" style="width:10%">Gender</th>
                    ...
                    <tbody>
                        ...
                        @forelse($data as $row)
                            ...
                            <tr>
                                ...
                                <td class="fw-normal">{{ $row->firstName ? $row->firstName : 'Guest' }} {{ $row->lastName }}</td>
                                <td class="fw-normal">{{ $row->email }}</td>
                                <td class="fw-normal">{{ $row->phone ? $row->phone : '-'  }}</td>
                                <td class="fw-normal">
