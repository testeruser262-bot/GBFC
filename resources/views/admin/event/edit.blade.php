...
<div class="card border-0 shadow-sm p-4" style="border-radius: 20px;">
    <div class="d-flex justify-content-start align-items-center">
        ...
        <div class="ms-3">
            <span class="fs-6 text-primary fw-bolder">Event / Edit</span><br/>
            <span class="fw-bold pt-3 fs-5">Edit Event</span>
        </div>
...
<div class="card border-0 shadow-sm p-4 mt-4" style="border-radius: 20px;">
    <div class="card-body">
        ...
        <form id="eventForm" action="{{ url('admin/event/update/'.$event->eventId) }}" method="POST">
